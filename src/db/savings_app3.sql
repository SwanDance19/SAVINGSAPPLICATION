...
('root', '[{\"db\":\"savings_application\",\"table\":\"transaction_table\"},{\"db\":\"savings_application\",\"table\":\"tbl_user\"}]');
...
('root', '2024-05-17 16:19:40', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `savings_application` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `savings_application`;
...
(1006, 'jhon', 'suansing', 'jhonsuansing@gmail.com', 'jhonsuansing133', 'SnZApCdLmZX7qoGJQi1IdR+8cLYiDR/RbnpF61NsQdY=', 'User', 'Active', 500.00);
