 ...
 * @author SCC
 */
public class depHis extends javax.swing.JFrame {
...
ResultSet rs = dbc.getData("SELECT "
    ...
    private void initComponents() {
        ...
        depTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jLabel1.setText("Deposited History");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(depHis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
